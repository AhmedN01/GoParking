...
Color textxolor=const Color(0xff75788D);
Color selectcolor=const Color(0xff2378EF);
Color semcolors=const Color(0xffF9FBFC);
Color greyprofile=const Color(0xffD9D9D9);
Color greytext=const Color(0xffC4C4C4);
