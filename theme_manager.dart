...
class ColorNotifire with ChangeNotifier {
  ...
  get getgreywhitecolor => isDark ? WhiteColor :  textxolor;
  get getselectbluewhite => isDark ? WhiteColor :  selectcolor;
  get getreceiptcolor => isDark ? darkmode : greyColor;
  get getsem => isDark ? semcolors : semcolors;
  get getprofile => isDark ? selectcolor : greyprofile;
  get getprofiletext => isDark ? WhiteColor : greytext;
}